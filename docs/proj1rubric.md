...
|--------|------|---------------------------------------------------------------------------|
|Video1|3||
|Video2|3|https://github.com/chetana-c/Enigma#readme|
|Workload is spread over the whole team (one team member is often Xtimes more productive than the others...|3| https://github.com/chetana-c/Enigma/graphs/contributors               |
|but nevertheless, here is a track record that everyone is contributing a lot)|3| https://github.com/chetana-c/Enigma/graphs/contributors               |
|Number of commits|3| https://github.com/chetana-c/Enigma/graphs/contributors               |
|Number of commits: by different people|3| https://github.com/chetana-c/Enigma/graphs/contributors               |
|Issues reports: there are many|3| https://github.com/chetana-c/Enigma/issues                            |
|Issues are being closed|3| https://github.com/chetana-c/Enigma/issues?q=is%3Aissue+is%3Aclosed   |
|DOI badge: exists|3| https://github.com/chetana-c/Enigma                                   |
|Docs: doco generated, format not ugly|3| Yes, In Docs Folder or main readme                                        |
|Docs: what: point descriptions of each class/function (in isolation)|3| Yes, https://github.com/chetana-c/Enigma/tree/main/docs               |
|Docs: how: for common use cases X,Y,Z mini-tutorials showing worked examples on how to do X,Y,Z|3| Yes https://github.com/chetana-c/Enigma                               |
|Docs: why: docs tell a story, motivate the whole thing, deliver a punchline that makes you want to rush out and use the thing|3| https://github.com/chetana-c/Enigma                                   |
|Docs: short video, animated, hosted on your repo. That convinces people why they want to work on your code.|3| https://github.com/chetana-c/Enigma                                   |
...
|Use of code coverage|3| https://github.com/chetana-c/Enigma                                   |
|Other automated analysis tools|3| https://github.com/chetana-c/Enigma/actions                           |
|Test cases exist|3| https://github.com/chetana-c/Enigma/tree/main/tests                   |
|Test cases are routinely executed|3| https://github.com/chetana-c/Enigma/actions                           |
|The files CONTRIBUTING.md lists coding standards and lots of tips on how to extend the system without screwing things up|3| https://github.com/chetana-c/Enigma/blob/main/CONTRIBUTING.md         |
...
|Evidence that the whole team is using the same tools (e.g. tutor can ask anyone to share screen, they demonstrate the system running on their computer)|3| https://github.com/chetana-c/Enigma/graphs/contributors               |
|Evidence that the members of the team are working across multiple places in the code base|3| https://github.com/chetana-c/Enigma/graphs/contributors               |
|Short release cycles|3| Yes. https://github.com/chetana-c/Enigma/graphs/contributors          |
|Does your website and documentation provide a clear, high-level overview of your software?|3| https://github.com/chetana-c/Enigma                                   |
|Does your website and documentation clearly describe the type of user who should use your software?|3| https://github.com/chetana-c/Enigma                                   |
...
|Does your software list the web address, and licences for all third-party dependencies and say whether the dependencies are mandatory or optional?|3| Yes https://github.com/chetana-c/Enigma/blob/dev/requirements.txt     |
